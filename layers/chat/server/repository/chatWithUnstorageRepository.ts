...
// import { getProjectById } from "./projectWithUnstorageRepository";

// // const chats: Chat[] = [MOCK_CHAT]
// const storage = useStorage<Chat[]>("db");
// // to nam utworzy plik json w .data/db/chats/all.json
// // mógłbyś to zagłębiać dalej chats:all:nestedstructere
